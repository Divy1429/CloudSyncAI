      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Automate your data workflows with AI-powered intelligence and real-time synchronization
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[600px]">
          <div className="md:col-span-2">
            <BentoCard
              title="AI-Powered Sync"
              value="Intelligent"
              subtitle="Automatically sync and transform data across all your systems with machine learning"
          ...
          <BentoCard
            ...
            value="24/7 Active"
            subtitle="Monitor data flow and detect issues instantly"
          ...
          <BentoCard
            ...
            value="99.9%"
            subtitle="Uptime SLA guaranteed"
          ...
          <div className="md:col-span-2">
            <BentoCard
              ...
              value="SOC 2 Type II"
              subtitle="End-to-end encryption with full audit trails and compliance with GDPR, HIPAA, and SOC 2"
          ...
          <div className="md:col-span-3">
            <BentoCard
              ...
              value="500+ Systems"
              subtitle="Connect to any data source or destination with pre-built connectors and custom API integrations"
