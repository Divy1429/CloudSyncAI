            ...
            {user ? (
              <>
                ...
                <Button
                  ...
                  className="text-xs md:text-sm text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-950/20 transition-all duration-200 rounded-xl px-2 md:px-3 lg:px-4"
                >
